export const TRAFFIC_NODE_FLASH_MS = 0;
export const GROUND_STATION_FOCUS_FLASH_MS = 3_400;
export const TRAFFIC_REPLAY_MAX_EVENTS = 20_000;
export const TRAFFIC_REPLAY_MIN_STEP_MS = 180;
export const TRAFFIC_REPLAY_MAX_STEP_MS = 60_000;
export const TRAFFIC_FALLBACK_MIN_DISTANCE_KM = 180;

export const FALLBACK_TRAFFIC_NODE_CITIES = [
